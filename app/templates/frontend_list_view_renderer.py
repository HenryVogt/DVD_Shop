...
def render(context):
    ...
    context['list_rows'] = "\n".join([tpl['frontend_product_list_row'].format(product = product, **context) for product in context['list_data_dict']])
    context['list_head'] = tpl['frontend_product_list_head']
